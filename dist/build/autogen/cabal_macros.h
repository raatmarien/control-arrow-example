...
/* package arrow-examples-0.1.0.0 */
#define VERSION_arrow_examples "0.1.0.0"
#define MIN_VERSION_arrow_examples(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "arrow-examples-0.1.0.0"

#define CURRENT_PACKAGE_KEY "arrow-examples-0.1.0.0"
